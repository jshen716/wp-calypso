...
/**
 * Determines whether the specified product slug is for a Google Workspace Business Starter.
 *
...
/**
 * Determines whether the specified product slug refers to any type of G Suite or Google Workspace product.
 *
 * @param {string} productSlug - slug of the product
 * @returns {boolean} true if the slug refers to any G Suite or Google Workspace product, false otherwise
 */
export function isGSuiteOrExtraLicenseOrGoogleWorkspaceProductSlug( productSlug ) {
 ...
 *
 * @param {string} productSlug - slug of the product
 * @returns {boolean} true if the slug refers to a G Suite or Google Workspace, false otherwise
 */
