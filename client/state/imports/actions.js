...
const receiveImporterStatus = ( importerStatus ) => ( dispatch, getState ) => {
	if ( ! isImporterLocked( getState(), importerStatus.importerId ) ) {
		dispatch( { type: IMPORTS_IMPORT_RECEIVE, importerStatus } );
	}
};
